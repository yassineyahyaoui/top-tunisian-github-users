...
The `total contributions` by users in Tunisia on `10 Aug 2022 07:36`. This list contains users from `Tunisia` and cities `Tunis` `Sfax` `Sousse` `Kairouan`.
...
<tr>
    ...
    Mohamed Amine Mahmoud    </td>    <td>Sopra HR Software</td>    <td align="center">10,303</td></tr>
<tr>
    ...
    Jbira Neirouz    </td>    <td>No company</td>    <td align="center">9,070</td></tr>
